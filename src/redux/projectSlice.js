...
const projectSlice = createSlice({
  ...
  initialState: {
    selectedProject: {
      ...
      type: localStorage.getItem('selectedProjectType') || null,
    },
  },
  reducers: {
    setSelectedProject: (state, action) => {
      const { name, type } = action.payload;
      state.selectedProject = { name, type };
      localStorage.setItem('selectedProjectName', name);
      localStorage.setItem('selectedProjectType', type);
    },
    clearSelectedProject: (state) => {
      state.selectedProject = { name: null, type: null };
...
//     },
//     clearSelectedProjectName: (state) => {
...
// export const { setSelectedProjectName, clearSelectedProjectName } = projectSlice.actions;
